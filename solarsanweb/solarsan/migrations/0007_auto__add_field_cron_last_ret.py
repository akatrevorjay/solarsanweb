...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cron.last_ret'
        db.add_column('solarsan_cron', 'last_ret',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cron.last_ret'
        db.delete_column('solarsan_cron', 'last_ret')
    ...
    models = {
        ...
        'solarsan.cron': {
            ...
            'last_ret': ('django.db.models.fields.IntegerField', [], {'default': '0'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Pool', fields ['guid']
        db.create_unique('solarsan_pool', ['guid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Pool', fields ['guid']
        db.delete_unique('solarsan_pool', ['guid'])

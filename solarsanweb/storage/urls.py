...
urlpatterns = patterns('storage.views',
    (r'^storage.health/(?P<slug>[A-z0-9_\-]+)$', storage.views.PoolHealthDetailView.as_view()),
    (r'^storage.analytics/(?P<slug>[A-z0-9_\-]+)$', storage.views.PoolAnalyticsDetailView.as_view()),
    (r'^storage.detail/(?P<slug>[A-z0-9_\-]+)$', storage.views.PoolDetailView.as_view()),

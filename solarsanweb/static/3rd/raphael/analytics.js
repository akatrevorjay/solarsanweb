...
function draw_analytics(g) {
    ...
    // Grab the data
    var labels = graphs[g]['labels'],
        data = graphs[g]['values'];
    ...
    graphs[g]['analytics'] = r.drawGrid(leftgutter + X * .5 + .5, topgutter + .5, width - leftgutter - X, height - topgutter - bottomgutter, 10, 10, "#000");
    ...
    for (var i = 0, ii = labels.length; i < ii; i++) {
        ...
        blanket.push(r.rect(leftgutter + X * i, 0, X, height - bottomgutter).attr({stroke: "none", fill: "#", opacity: 0}));

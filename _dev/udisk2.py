...
# TODO: move Signal and _SignalDescriptor to a dedicated modules as they are
# just too cool to loose. :-)
class Signal(object):
    """
...
if True:
    ...
    try:
        ...
        if exc.get_dbus_name() == "org.freedesktop.DBus.Error.ServiceUnknown":
            ...
            print("In practice you should run this script on Ubuntu 12.10")
            print("(aka 'quantal'). You can use a Live CD to do that without")
            print("having to upgrade your existing installation")
            raise SystemExit(1)
        else:
